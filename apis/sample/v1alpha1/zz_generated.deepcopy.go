...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MyTypeResultStats) DeepCopyInto(out *MyTypeResultStats) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MyTypeResultStats.
func (in *MyTypeResultStats) DeepCopy() *MyTypeResultStats {
	if in == nil {
		return nil
	}
	out := new(MyTypeResultStats)
	in.DeepCopyInto(out)
	return out
}
